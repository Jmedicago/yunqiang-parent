...
<div class="tab-wrap">
    <div class="tableGroup">
        ...
        <div id="roleTB">
            <div>
                <a href="#" data-cmd="add" remote="false" class="easyui-linkbutton" iconCls="icon-add" plain="true">
                    <span i18n="table.add">添加</span>
                </a>
                <a href="#" data-cmd="edit" mustsel remote="false" data-options="disabled:true" class="easyui-linkbutton"
