...
<form method="post" style="width: 600px; margin: 30px auto;" action="/stock-shunt/shunt">
    ...
    <div class="input-div">
        <label class="label-top">分流订单号</label>
        <input class="easyui-textbox theme-textbox-radius" value="${bisStockShunt.remark}" data-options="multiline:true" style="height:60px;width:450px;"
               name="remark">
    </div>
