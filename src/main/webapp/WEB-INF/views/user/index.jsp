    ...
    <div class="tableGroup">
        <table id="userGrid" class="easyui-datagrid" title="<spring:message code="mu.sys.user"/>"
            ...
            <tr>
                ...
                <th data-options="field:'roleIds',width:100,formatter: function(val, row){ return MXF.cellTooltipFormatter(row.roleList)}">
                    <spring:message code="user.roles"/></th>
                <th data-options="field:'manager',width:100">负责人</th>
                <th data-options="field:'phone',width:100">联系电话</th>
                <th data-options="field:'stockIds',width:100,formatter: formatterStockPath">
                    归属区域
                </th>
                <th data-options="field:'remark', width:150, formatter:MXF.cellTooltipFormatter">门店描述</th>
                <th data-options="field:'status',width:50,formatter:userStateFormatter"><spring:message
        ...
        <div id="userTB">
            <div>
                <a href="#" data-cmd="add" title="<spring:message code="common.add"/>" remote="false"
                ...
                <a href="#" data-cmd="del" title="<spring:message code="common.delete"/>"
                   msg="<spring:message code="message.delete"/>" mustsel remote="false" data-options="disabled:true"
                   class="easyui-linkbutton"
                   iconCls="icon-no" plain="true">
                    <spring:message code="common.delete"/>
                </a>
                <span class="buttonSplit">&nbsp;</span>
                <a href="#" data-cmd="modifyPsw" class="easyui-linkbutton"
                   title="<spring:message code="user.btn.mpass"/>" mustsel remote="false"
...
<script type="text/javascript">
    ...
    function formatterStockPath(val, row) {
        var path = '';
        $.ajax({
            type: "GET",
            url: "/stock/getPath",
            data: {id: row.stockIds},
            async: false,
            success: function (data) {
                path = data.data;
            }
        })
        return MXF.cellTooltipFormatter(path);
    }
</script>
